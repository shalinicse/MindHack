          ...
          <div id="latest-news">
			...
			<h4>Enter Your id</h4>
                    <form class="customform" action="" method="post">
                      <div class="s-12"><input name="sid" placeholder="Your id" title="Your e-mail" type="text" value="<?php echo $_SESSION['usrid'];?>" /></div>
					  <div class="s-12 m-12 l-offset-4 l-3"><button class="color-btn" name="show" type="submit">Show</button></div>
					  </form>
					  <br>
					  <form class="customform" action="" method="post">
							 <div class="col-md-12">
...
<h4 style="color:red">Enter Test id for Statiscal View of that particular Report</h4>
<div class="s-12"><input name="tid" placeholder="test id"type="text"  /></div>

 <div class="s-12 m-12 l-offset-4 l-3"><button class="color-btn" name="graph1" type="submit">Statiscal View</button></div>
<?php
