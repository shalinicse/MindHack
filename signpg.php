...
<img src="img/images1.jpg"/></div>
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="img/sign_1.jpg" alt="Los Angeles" width="1200px" >
		
      </div>

      <div class="item">
        <img src="img/sign_2.jpg" alt="Chicago" width="100%" >
      </div>
    
      <div class="item">
        <img src="img/sign_3.jpg" alt="New york" width="100%" >
      </div>
	  <div class="item">
        <img src="img/sign_4.jpg" alt="New york" width="100%" >
      </div>
	  <div class="item">
        <img src="img/sign_5.jpg" alt="Chicago" width="100%" >
      </div>
	  <div class="item">
        <img src="img/sign_6.png" alt="Chicago" width="100%" >
      </div>
    </div>
