	...
	<!--about block-->	 
            ...
            <div class="s-12 m-12 l-8 l-offset-2 media-container">
             ...
             <article class="s-12 m-12 l-8 l-offset-2">
               <h2>Physical Activity Classes</h2>
				 
	       <p class="lead">
			  Improve core strength, balance, and flexibility. Plus, build exercise and 
			   movement into your everyday routine.
		  </p>
				 
<h3>Strengthening with Suspension:</h3>

<p>Develop your strength, cardiovascular fitness, coordination and stability with
   the use of a suspension trainer; a system of straps and handles allowing you
   to train with your own body weight.</p>

<p>45 minutes - $10</p>

<h3>Therapist:</h3>

<p>Improve your core strength, balance, and flexibility in this 
   introductory mat class led by our certified therapist instructors.</p>

<p>45 minutes - $10</p>

<h3>Get Balanced:</h3>

<p>Improve your standing balance in this quick and easy workout.
   You'll strengthen your lower body, improve core strength and decrease your 
   risk for all related injuries.</p>

<p>45 minutes- $10</p>

<h4>Elements of Movement:</h4>

<p>Improve your mobility and coordination while you learn more about the ways your body can move.</p>
