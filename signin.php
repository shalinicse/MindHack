			   ...
			   <center>
			      <div class="s-12 m-12 l-5">
                    ...
                    <form class="customform" action="" method="post">
					  <div class="s-12"><input name="sid" placeholder="Enter User id" title="Your ID" type="email" required /></div>
                      <div class="s-12"><input name="pwd" placeholder="Enter Password" title="Your Password" type="password"d/></div>
                      <div class="s-12 m-12 l-4"><button class="color-btn" type="submit" href="signpg.php" name="login">Sign In</button></div>
					  <a class="left" href="signup.php" title="Responsee - lightweight responsive framework">New User?</a>&nbsp;&nbsp;&nbsp;
                      <button class="left"  title="Responsee - lightweight responsive framework" name="forget">Forget Password?</button>
						<?php
						session_start();
						 ...
						 {
							 $_SESSION['ques_id']=array(29);
							 
							 $_SESSION['usrname']=$_POST['sid'];
							 $pwd=$_POST['pwd'];
							 $sid=$_SESSION['usrname'];
							  
							  $_SESSION['usrid']=$_POST['sid'];
							  include("config.php");
							  $pwd=hash('sha256',$pwd);
							  $sql="select * from student where  password='$pwd' and sid='$sid'";
							  $rs=mysql_query($sql);
