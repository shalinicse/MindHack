                     ...
                     <div class="s-12 m-12 l-5">
                       <h3>Update Info</h3>
                        <form class="customform"  method="post" enctype="multipart/form-data">
						  ...
						  <div class="s-12"><h5>Enter new name</h5><input name="name" placeholder="Enter your name" title="Your name" type="text" required /></div>
							
							<div class="s-6 "><h5>Upload new Profile Pic</h5> <input class="color-btn" type="file" name="photo"/></input></div>
							
							<div class="s-12"><h5>Enter new college</h5> <input name="college" placeholder="Enter Your Institute Name" title="Institute Namme" type="text" required/></div>
							
							<div class="s-12"><h5>Enter new contact</h5> <input name="mob" placeholder="Enter Your Contact no" title="contact no"type="text" pattern="[789][0-9]{9}"required /></div>
							
							<div class="s-12"><h5>Enter new password</h5> <input name="pwd" placeholder="Set password" title="password" type="password" required/></div>
							<div class="s-12"><input name="cpwd" placeholder="Confirm Your Password" title="confirmpassword" type="password" required /></div> 
							<div class="s-12 m-12 l-4"><button  class="color-btn" type="submit" name="btninsert">Update Now</button></div>
          <?php
...
WHERE
    condition;*/
			...
			{	
				...
				if(move_uploaded_file($tmppath,"img/profile/".$pic_name))
	 ...
	 sid='$sid';";	mysql_query($sql);
			...
			header("location:signpg.php");
			else
			header("location:upd_info.php");
	...
	?>		 
			...
			<div class="s-12 m-12 l-6 hide-m hide-s margin-bottom right-align">
                    <br><img class="col-md-offset-2"src="img/update.jpg" alt="">
             </div>
          </div>
         </div>      
