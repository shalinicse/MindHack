...
<img src="img/images1.jpg"/></div>
	...
	<!--about block-->	 
            ...
            <div class="s-12 m-12 l-8 l-offset-2 media-container">
                 <img src="img/healthy3.jpg" alt="">

            </div>
             <article class="s-12 m-12 l-8 l-offset-2">
               <h2>Physical Activity Assements</h2>
				 
	       <p class="lead">
			  Based upon your own needs and goals, you will be able to choose from two&nbsp;
			  levels of Physical Activity Assessments: Enhanced, or Optimized. Complete with a Mayo Clinic 
			  level of interpretation, you'll gain the knowledge, data, and expert guidance needed to succeed.
			  Whether you are a new exerciser, professional or everyday athlete, you can break through to
			  your next level of physical conditioning.
		  </p>
				 
<div class="callout-action row gutter-bottom">
<div class="col-xs-12 col-sm-9">
<h3>Enhanced Assessment &ndash; 5 hours</h3>
</div>

<div class="col-xs-12 col-sm-3 text-right">
<p class="lead"><h3>Price:550*</h3></p>
</div>
</div>
<h4>Biometric Evaluation:</h4>


        <p>
            Tests blood pressure and blood values (cholesterol and glucose) in order to provide our
			team a snapshot of your current health status and risk of disease.

        </p>
		
<h4>Body Composition Scan:</h4>

<p>Accurately measures your bone density, percentage of muscle of fat and distribution using
    Dual-Energy X-ray Absorptiometry (DEXA) technology, so you can have the data to succeed.</p>

<h4>Cardiovascular & Resistance Plan:</h4>

<p>Receive a training plan tailored to your physical activity goals to help guide your future workouts.</p>

<h4>Cardiovascular Stress Test:</h4>

<p>Assesses the amount of oxygen you use during exercise, allowing us to gauge your cardiovascular
      fitness level.</p>

<h4>Strength Assessment:</h4>

<p>Tests upper and lower body strength to provide you with appropriate goals to increase
     muscular strength and endurance.</p>

<h4>Meals Included:</h4>

  <p>Breakfast and healthy snacks are provided to keep you fueled.</p>

<h4>Movement Assessment:</h4>

<p>Gain detailed insight to your overall movement, strength, flexibility, alignment, balance,
    and posture&ndash;all of which impact your exercise program and day-to-day activities.</p>

<h4>Physician-Led Assessment Review:</h4>

<p>Review your results with a our therapist and your Healthy Living Program team of experts,
        who will take the time to answer your questions.</p>

		
 <div class="callout-action row gutter-bottom">
<div class="col-xs-12 col-sm-9">
<h3>Optimized Assessment &ndash; 8 hours</h3>
</div>

<div class="col-xs-12 col-sm-3 text-right">
<p class="lead"><h3>Price:850*</h3></p>
</div>
</div>

<h4>Customization:</h4>

<p>Complete a pre-visit health questionnaire, providing information on your current activity
   levels and overall wellness goals. This level of personalization ensures a customized 
   assessment offering just for you.</p>

<h4>Personalized Activity Plan:</h4>

<p>Receive a comprehensive physical activity plan to help you achieve your goals.
   This includes your individualized cardio and strength training recommendations,
   training goals, target heart rate zones, and resistance training guide.</p>

<h4>Cardiovascular Stress Test:</h4>

<p>Assesses the amount of oxygen you use during exercise, allowing us to gauge your 
    cardiovascular fitness level.</p>


<h4>2-Hour Exercise Experience:</h4>

<p>Train one-on-one with your personal team of experts at our state-of-the-art facility to
   ensure you leave with the knowledge and skills to break through to your next level
   of fitness.</p>

<h4>Physical Activity Planning and Goal Setting Session:</h4>

<p>Develop and discuss the action items needed for your success with your personal
    team of experts.</p>
