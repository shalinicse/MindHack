...
<img src="img/images1.jpg"/></div>
      ...
      <section>
            <div class="line">
                <h2 class="section-title">Sign Up</h2>
                     ...
                     <div class="s-12 m-12 l-5">
                       <h3>Sign up form</h3>
                        <form class="customform"  method="post" enctype="multipart/form-data">
						 <div class="s-12"><input name="sid" placeholder="Your email id" title="Student id" type="email" required/></div>
                 ...
                 <div class="s-12"><input name="mob" placeholder="Enter Your Contact no" title="contact no"type="text" pattern="[789][0-9]{9}"required /></div>
				<div class="s-12"><input name="pwd" placeholder="Set password" title="password" type="password" required/></div>
     ...
     if(isset($_POST["btninsert"]))
		...
		else
		{
			 ...
			 if(empty($pic_name)==true)
			 {
				 
				// $sql="insert into student(name,dob,sex,contact,password,institute,sid,book) values('$name','$dob','$sex','$mob','$pwd','$college','$sid','$book')";
					$sql="insert into student values('$name','$dob','$sex','$mob','$pwd','$college','default.jpeg','$sid','$book')";
