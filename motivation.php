        ...
        <div class="row">
			<div class="col-md-12">
                   ...
                   <?php
					   ...
					   $sql="select * from video ORDER BY vid;";
				$rs=mysql_query($sql);
				...
				while($row=mysql_fetch_array($rs))
				{
					...
					<iframe src="https://www.youtube.com/embed/<?php echo $row['link'];?>?autoplay=0">
					</iframe></div>
					
					</div>
					<div class=" right-align col-md-6">
					<div class=" col-md-offset-2 right-align">
					
					<h3><a href="<?php echo $row['name'];?>"><?php echo "Motivational video"." ".$row['vid'];?></a></h3>
					<p class="justified"><h4><?php echo $row['description'];?><h4></p>
					</div>
					 </br>
					  </br>
					 </br>
