            ...
            <div class="line">
                ...
                <div class="margin">
				  <div class="s-12 m-12 l-5">
                    ...
                    <h4>Your message to Therapist</h4>
...
document.getElementById("demo").innerHTML = Date();
                      ...
                      <h4>Your Problem</h4>
					  <div class="s-12">
					  <textarea placeholder="Your problem" name="msg" rows="5"></textarea>
					  </div>
					  <div class="row">
					  <div class="col-md-5"><button class="color-btn" name="message" type="submit">Send Message</button></div>
					  <div class="col-md-offset-2 col-md-5"><button class="color-btn" name="old_message" type="submit">Old Messages</button></div>
					  </div>
    ...
    if(isset($_POST["message"]))
	 {
		...
		// $mail=$_POST['mail'];
		 ...
		 include("config.php");
		 $sql="insert into share(date,userid,problem) values(CURDATE(),'$sid','$msg');";
		mysql_query($sql);
	...
	?>
			 ...
			 <div class="s-12 m-12 l-6 hide-m hide-s margin-bottom right-align">
                    <img class="col-md-offset-2"src="img/sentbox.jpg" alt="">
             </div>
               </div>
            </div>
      </section>
