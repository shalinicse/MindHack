			   ...
			   <center>
			      <div class="s-12 m-12 l-5">
                    ...
                    <form class="customform" action="" method="post">
                      ...
                      <div class="s-12"><input class="readonly" title="User id" type="text" value="<?php   echo $_SESSION['usrid'];?>" /></div>
					  <div class="s-12"><input name="book" placeholder="Enter Book Name" title="Your Book" type="text" /></div>
                      <div class="s-12 m-12 l-4"><button class="color-btn" type="submit" href="signpg.php" name="login">Sign In</button></div>
					  <?php
					 
					  if($_SESSION["usrid"] == null)
					  ...
					  $sql="select book,name from student where sid='$sid';";
					  $rs= mysql_query($sql);
	   ...
	   <!-- FIRST BLOCK -->
         <div id="first-block">
            <div class="line">
               ...
               <div class="s-12 m-4 l-2 center"><a class="white-btn" href="#test">Take The Test Now</a></div>
